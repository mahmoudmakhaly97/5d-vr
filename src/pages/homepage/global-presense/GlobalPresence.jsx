...
const GlobalPresence = () => {
  return (
    <section id="quote-2" className="section padding-vertical  ">
        ...
        <Row>
          ...
          <Col lg={6}>
            <blockquote className="d-flex align-items-center">
              Our Global Presence : Proudly Collaborating with Clients Around
              the World
            </blockquote>
            <p className="my-4 text-gary ">
              ...
              such as education, healthcare, entertainment, real estate, and
              more.
            </p>
